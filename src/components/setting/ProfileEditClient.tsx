      ...
      <div className="flex flex-col h-full justify-between">
        <div className="flex-1">
          <div className="relative px-4 py-6 flex items-center">
            ...
            <h1 className="absolute left-1/2 transform -translate-x-1/2 text-lg font-semibold text-gray-900">프로필 편집</h1>
          </div>
                ...
                {[1, 2, 3, 4, 5, 6].map((index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      {isSelected && (
                        <div className={`absolute -top-1 -right-1 w-6 h-6 ${colors.bg} rounded-full flex items-center justify-center z-10`}>
                          <Image
