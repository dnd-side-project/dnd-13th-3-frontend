...
export default function GoalEditModal({ isOpen, onClose, onSave, initialGoal }: GoalEditModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-end z-50">
      <div className="w-96 bg-white rounded-t-2xl flex flex-col items-center">
        ...
        <div className="w-80 py-4 flex flex-col items-center gap-2">
          <p className="w-full text-gray-800 text-xs font-medium font-pretendard leading-none tracking-tight">목표 수정</p>
          <div className="w-full h-16 flex flex-col justify-start items-end gap-2 mt-2">
            ...
            <p className="self-stretch text-right text-gray-400 text-xs font-normal font-pretendard leading-none tracking-tight">({goal.length}/20)</p>
          </div>
        </div>
